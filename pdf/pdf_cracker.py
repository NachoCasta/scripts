...
checklist=["pdfid", "pdf-parser", "pdfcrack",
             "rockyou", "pdf2john", "hashcat", "qpdf"]
installed=True
...
def crack(filename):
    ...
    os.system("qpdf --show-encryption '" + filename +
              "' 2>&1 | tee F1.txt > F1.txt")
...
# -------------------------------------------------------------------------------------
    ...
    if selection == '1':
        ...
        if os.path.isfile(dictionary):
            ...
            exit(True)
        os.system("pdfcrack '" + filename +
                  "' -n 6 -w " + dictionary + " > F1.txt")
        ...
        if pdfpassword == "":
            ...
            os.system("qpdf --password=" + pdfpassword +
                      " --decrypt '" + filename + "' Cracked.pdf")
...
# -------------------------------------------------------------------------------------
        ...
        os.system("hashcat -m " + level +
                  " -a 3 F1.txt -i ?d?d?d?d?d?d --force > F2.txt 2>&1")
        ...
        if hashpass == "":
            ...
            os.system("qpdf --password=" + hashpass +
                      " --decrypt '" + filename + "' Cracked.pdf")
            print("Cracked filename  : Cracked.pdf\n")
        os.remove('F1.txt')
        os.remove('F2.txt')
